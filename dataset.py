...
class DatasetFromFolder(data.Dataset):
    def __init__(self, image_dir,dataframe_dir,vocab_dir, transform=None):
        ...
        filenames = [ "{}.jpg".format(x) for x in self.ava_table.index ]
    ...
    def __getitem__(self, index):
        ...
        comment = self.ava_table.ix[index].comments
...
def get_loader(image_dir, dataframe_dir, vocab, transform, batch_size, shuffle, num_workers):
    ...
    dset = DatasetFromFolder(root=image_dir,
                       json=json,
                       vocab=vocab,
                       transform=transform)
